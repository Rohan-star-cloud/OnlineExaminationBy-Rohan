...
if (empty($existing_result)) {
    // Insert new result using correct column names
    $exam->data = array(
        ':user_id' => $user_id,
        ':exam_id' => $exam_id,
    ...
    VALUES (:user_id, :exam_id, :marks_obtained, :total_marks, :exam_status)
    ";
} else {
    // Update existing result with correct column names
    $exam->data = array(
        ':marks_obtained' => $total_marks,
        ':total_marks' => $total_possible_marks,
        ':exam_status' => 'Completed',
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo $current_exam_class; ?>">
                            ...
                            <td>
                                <?php 
                                if ($attempt_percentage >= 90) echo '<span class="badge bg-success">Outstanding</span>';
                                elseif ($attempt_percentage >= 80) echo '<span class="badge bg-success">Excellent</span>';
                                elseif ($attempt_percentage >= 70) echo '<span class="badge bg-primary">Very Good</span>';
                                elseif ($attempt_percentage >= 60) echo '<span class="badge bg-info">Good</span>';
                                elseif ($attempt_percentage >= 50) echo '<span class="badge bg-warning">Average</span>';
                                else echo '<span class="badge bg-danger">Poor</span>';
                                ?>
                            </td>
                            <td><strong><?php echo $attempt_percentage; ?>%</strong></td>
                            <td><?php echo $attempt['marks_obtained']; ?>/<?php echo $attempt['total_marks']; ?></td>
